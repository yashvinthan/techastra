                ...
                >
                    <div style={styles.startWindowInner}>
                        <div style={styles.verticalStartContainer}>
                            <p style={styles.verticalText}>TechastraOS</p>
                        </div>
                        <div style={styles.startWindowContent}>
                            <div style={styles.startMenuUnivHeader}>
                                <img
                                    src={mgrLogo}
                                    alt="Dr. M.G.R. University"
                                    style={styles.startMenuUnivLogo}
                                />
                            </div>
                            <div
